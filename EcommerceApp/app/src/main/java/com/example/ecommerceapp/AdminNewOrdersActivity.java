...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder adminOrdersViewHolder, @SuppressLint("RecyclerView") final int i, @NonNull AdminOrders adminOrders) {
                        adminOrdersViewHolder.userName.setText("Name: "+adminOrders.getName());
                        adminOrdersViewHolder.userPhoneNumber.setText("Phone No: "+adminOrders.getPhone());
                        ...
                        adminOrdersViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Have you delivered this products? ");
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder{
        ...
        public AdminOrdersViewHolder(@NonNull View itemView) {
            ...
            userPhoneNumber= itemView.findViewById(R.id.order_phone_no);
